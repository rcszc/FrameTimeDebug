...
namespace FTDthread {
	...
	protected:
		...
		static std::mutex       GLOBAL_MUTEX;       // points,texts.
		static std::mutex       GLOBAL_MUTEX_FRAME; // frame.

		static std::queue<std::string> GLOBAL_TEXTS_CACHE;
		static std::queue<FTD_SYS_GLOBAL::SrcDataSamplingPoint> GLOBAL_POINTS_CACHE;
		static std::queue<FTD_SYS_GLOBAL::SrcDataSamplingFrame> GLOBAL_FRAME_CACHE;
